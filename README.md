...
6. Реализация черного списка для для каждого пользователя
7. Реализация Рейтинга у клиентов и мастеров
8. Реализация Подписок на Клиентов и мастеров
9. Реализация Просмотра заказов на которые подана заявка(Мастер)
10. Реализация Просмотра моих опубликованных заказов(Клиент)
